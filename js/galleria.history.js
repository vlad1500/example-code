...
Galleria.History = (function() {
    ...
    var onloads = [],
        ...
        get = function( winloc ) {
            ...
            return parseInt( winloc.hash.substr(11), 10 );
        },
        ...
        onchange = function() {
          var thisHash = loc.hash;
          if(thisHash.indexOf("Slideshow~") != -1) {
            console.log("change fired");
            //goPaginationSlide();
            $.each( callbacks, function( i, fn ) {
                fn.call( window, get() );
            });
            //$("#container").flipBook.doPagination();
          }
        },
        //josh
