...
(function(window, Util){
	...
	Code.PhotoSwipe.ToolbarClass = Code.PhotoSwipe.ElementClass.extend({
		...
		init: function(options){
            ...
            // logo
			this.logoEl = Util.DOM.createElement('div', { 'class': Code.PhotoSwipe.ToolbarClass.CssClasses.logo+" menuItem" }, '<div class="' + Code.PhotoSwipe.ToolbarClass.CssClasses.content + '"></div>');
			Util.DOM.appendChild(this.logoEl, this.el);

			// top10
			this.top10El = Util.DOM.createElement('div', { 'class': Code.PhotoSwipe.ToolbarClass.CssClasses.top10+" menuItem" }, '<div class="' + Code.PhotoSwipe.ToolbarClass.CssClasses.content + '"></div>');
			Util.DOM.appendChild(this.top10El, this.el);

			// add photo
			this.aphotoEl = Util.DOM.createElement('div', { 'class': Code.PhotoSwipe.ToolbarClass.CssClasses.aphoto+" menuItem" }, '<div class="' + Code.PhotoSwipe.ToolbarClass.CssClasses.content + '"></div>');
            console.log(this.settings.btnAddPhoto);
            if(this.settings.btnAddPhoto)
    			Util.DOM.appendChild(this.aphotoEl, this.el);

            // Close
			this.closeEl = Util.DOM.createElement('div', { 'class': Code.PhotoSwipe.ToolbarClass.CssClasses.close+" menuItem" }, '<div class="' + Code.PhotoSwipe.ToolbarClass.CssClasses.content + '"></div>');
			...
			// fb like
			this.fblikeEl = Util.DOM.createElement('div', { 'class': Code.PhotoSwipe.ToolbarClass.CssClasses.fblike+" menuItem" }, '<div class="' + Code.PhotoSwipe.ToolbarClass.CssClasses.content + '"></div>');
			Util.DOM.appendChild(this.fblikeEl, this.el);
            //fb share
            this.fbshareEl = Util.DOM.createElement('div', { 'class': Code.PhotoSwipe.ToolbarClass.CssClasses.fbshare+" menuItem" }, '<div class="' + Code.PhotoSwipe.ToolbarClass.CssClasses.content + '"></div>');
			Util.DOM.appendChild(this.fbshareEl, this.el);
		...
		handleClick: function(e){
			...
			switch(e.target.parentNode){
				...
				case this.closeEl:
					...
					break;
                case this.logoEl:
					action = Code.PhotoSwipe.ToolbarClass.Actions.logo;
					break;
                case this.top10El:
					action = Code.PhotoSwipe.ToolbarClass.Actions.top10;
					break;
                case this.aphotoEl:
					action = Code.PhotoSwipe.ToolbarClass.Actions.aphoto;
					break;
                case this.fblikeEl:
					action = Code.PhotoSwipe.ToolbarClass.Actions.fblike;
					break;
                case this.fbshareEl:
					action = Code.PhotoSwipe.ToolbarClass.Actions.fbshare;
					break;
			}
		...
		resetPosition: function(){
			...
			//Util.DOM.setStyle(this.el, 'top', top + 'px');
            Util.DOM.setStyle(this.el, 'bottom', '0px');
			Util.DOM.width(this.el, Util.DOM.bodyWidth());
            //alert(window.orientation);
//            if(window.orientation == 90 || window.orientation == -90){
//                //alert("horizontal");
//                $(".ps-toolbar").css({"top":"0","width":"70px","height":"100%","left":"auto","right":"0px"});
//                $(".menuItem").css("display","table-row");
//            }else if(window.orientation == 0 || window.orientation == -180){
//                //alert("vertical");
//                $(".ps-toolbar").css({"bottom":'0px',"top":'auto',"width":"100%","height":"44px","left":"0px","right":"auto"});
//                $(".menuItem").css("display","table-cell");
//            }
		},
	...
	Code.PhotoSwipe.ToolbarClass.CssClasses = {
        ...
        logo: 'ps-toolbar-logo',
        top10: 'ps-toolbar-top10',
        aphoto: 'ps-toolbar-aphoto',
        fblike: 'ps-toolbar-fblike',
        fbshare: 'ps-toolbar-fbshare',
...
//			});
			...
			this.toolbar = new ToolbarClass({
                ...
                btnAddPhoto: this.settings.btnAddPhoto
			});
...
//					window.location.hash = this.currentHistoryHashValue;
		...
		onWindowHashChange: function(e){
            //showWarning(this.currentHistoryHashValue);
			//var compareHash = '#' +
...
//			}
		...
		onToolbarClick: function(e){
			...
			switch (e.action){
                ...
                case ToolbarClass.Actions.logo:
					this.showlogo();
					break;

                case ToolbarClass.Actions.top10:
					this.showTop10();
					break;

                case ToolbarClass.Actions.aphoto:
					this.showAddPhoto();
					break;

                case ToolbarClass.Actions.fblike:
					this.showFBLike();
					break;

                case ToolbarClass.Actions.fbshare:
					this.showFBShare();
					break;
