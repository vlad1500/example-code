...
zoomLevel:1,zoomMax:2,zoomBoundingBox:window,zoomStep:0.05,onZoom:null,flipSound:!0,flipSoundFile:["page-flip.mp3","page-flip.ogg"],flipSoundPath:"./wow_book/sound/",onPlayFlipSound:null,keyboardNavigation:{back:37,advance:39},clipBoundaries:!0,controls:{},onShowPage:!1,onHoldPage:null,onReleasePage:null};d.browser.ie8=d..ie&&8==d.browser.version;var l=d..ie&&9>d.browser.version?1:0,n={thin:2-l,medium:4-l,thick:6-l}})(jQuery);
...
(function(d){function t(j){if(j in r.style)return d.support[j]=j;for(var l=s.length,n,a=j.charAt(0).toUpperCase()+j.substr(1);l--;)if(n=s[l]+a,n in r.style)return d.support[j]=n}if(d.cssHooks){var r=document.createElement("div"),s=["O","ms","Webkit","Moz"];t("transform");t("transformOrigin");t("boxSizing");d.support.boxSizing&&d..ie&&7==d.browser.version&&(d.support.boxSizing=!1);r=null;d.support.transform&&"transform"!==d.support.transform&&!d.cssHooks.transform&&(d.cssHooks.transform={get:function(j){return d.css(j,
