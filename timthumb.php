...
if(! defined('NOT_FOUND_IMAGE') )		define ('NOT_FOUND_IMAGE', 'http://placehold.it/200x220');								// Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )			define ('ERROR_IMAGE', 'http://placehold.it/100x100');									// Image to serve if an error occurs instead of showing error message 
...
if(! defined('DEFAULT_Q') )				define ('DEFAULT_Q', 96);									// Default image quality. Allows overrid in timthumb-config.php
...
if(! defined('DEFAULT_CC') )			define ('DEFAULT_CC', 'F7F5F4');
