          ...
          <div id="main_inner">
            ...
            <!--home-->     
                <div id="my_home" class="tab2_content">
                    ...
                    <button id='button_main_next' class="bold float_right button-large" style="margin-top:10px">Get started</button>  
...
<script src="{$js}manipulate.min.js" type="text/javascript"></script>
