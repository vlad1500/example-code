                            ...
                            <div id="prev_" class="paginate-front-cover">Prev</div>
                                <ul>
                                	<?php  
										...
										$ppage = 1;
										for ($i = 1; $i <= $page_ ; $i++){									
                                			echo '<li><div id="'.$ppage.'" class="paginate-left-page">'.$i.'</div></li>';
											$ppage += 40;
                                    	} 
									?>
                                </ul>                          
...
<script type="text/javascript">
	$(document).ready(function(e) {
        ...
        $('#done_button').live('click', function(){
			$.ajax({
				url  : 'main/delete_pages',
				data : { 'fbdataid' : $.cookie('storedObj') },
				type : 'POSt',
				success : function(){},
			});
