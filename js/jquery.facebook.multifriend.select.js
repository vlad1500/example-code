...
(function($) { 
    var JFMFS = function(element, options) {
        ...
        elem.html(
            ...
            "    </div>" +
            "    <div id='jfmfs-friend-container'></div><input type='button' id='jfmfs-friend-container' name='jfmfs-friend-container' value='share on friends wall'></>" +
            "</div>" 
        );
        ...
        var init = function() {
            ...
            // filter by selected, hide all non-selected
            $("#share_to_frieds_wall").click(function(event) {
				event.preventDefault();
				$( "#jfmfs-friend-container .selected" ).each(function( index ) {
