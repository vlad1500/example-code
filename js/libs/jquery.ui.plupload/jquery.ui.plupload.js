		...
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Drag Image here.") + '</div>' +
...
//        uploader.attr("accept","image/*;capture=camera");
			...
			uploader.bind('FilesAdded', function(up, selectedFiles) {
				...
				if (extraCount > 0) {
					...
					up.trigger('Error', {
						...
						message : _('Too many images to Upload.'),
						file : removed
					});
				}
			});
		...
		uploader.bind('FilesAdded', function(up, files) {
			$('.filter_next_pro').css('background','#D3D3D3');
			 $('.filter_next_pro').css('border','1px solid #b3b3b3');
			 $('.filter_next_pro').css('opacity','0.35');
		...
		uploader.bind('UploadComplete', function(up, files) {
			...
			$('.filter_next_pro').css('background','#FF9839');
			$('.filter_next_pro').css('border','1px solid #E66D00');
			 $('.filter_next_pro').css('opacity','1');
				...
				if (details) {
					...
					switch (err.code) {
						...
						case self.FILE_COUNT_ERROR:
							details = _("You are trying to upload too many images, upload %d at a time, the first %d files will be uploaded from your selection")
